...
function getBaseUrl() {
    ...
    if (isset($_SERVER['HTTP_HOST']) && $_SERVER['HTTP_HOST'] === 'eli-larson.com') {
        return 'https://eli-larson.com';
    }
...
<head>
  ...
  <!-- Minimal inline CSS fallback for critical styling -->
  <style>
    /* Critical CSS fallback in case external CSS fails to load */
    :root {
  ...
  <noscript>
    <link rel="stylesheet" href="<?php echo $baseUrl; ?>/css/noscript.css">
  </noscript>
</head>
<body>
  <header class="site-header">
    <a href="index.php" class="logo">Eli Larson</a>
    <nav class="site-nav">
      <ul>
